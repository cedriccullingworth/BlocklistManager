...
public class BlocklistDbContext : DbContext
{
    ...
    {
        bool dataExists = this.FileTypes.Count( ) >= 9 && this.RemoteSites.Count( ) >= 23;
        if ( !dataExists )
        {
    ...
    {
        bool result = this.RemoteSites.Count( ) >= 23;
        if ( !result )
        {
            ...
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 2, Name = "MyIP", SiteUrl = "https://myip.ms", FileUrls = "https://myip.ms/files/blacklist/general/latest_blacklist.txt", FileTypeID = 9, LastDownloaded = new DateTime( 2024, 12, 18, 10, 00, 57 ), Active = true, MinimumIntervalMinutes = 0 } ); } catch { }
            ...
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 4, Name = "GreenSnow", SiteUrl = "https://greensnow.co/", FileUrls = "https://blocklist.greensnow.co/greensnow.txt", FileTypeID = 1, LastDownloaded = new DateTime( 2024, 12, 18, 10, 00, 45 ), Active = true, MinimumIntervalMinutes = 0 } ); } catch { }
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 5, Name = "AlienVault", SiteUrl = "https://reputation.alienvault.com", FileUrls = "https://reputation.alienvault.com/reputation.generic", FileTypeID = 8, LastDownloaded = new DateTime( 2024, 12, 15, 10, 48, 18 ), Active = true, MinimumIntervalMinutes = 0 } ); } catch { }
            ...
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 7, Name = "CI Army", SiteUrl = "https://cinsscore.com", FileUrls = "https://cinsscore.com/list/ci-badguys.txt", FileTypeID = 1, LastDownloaded = new DateTime( 2024, 12, 18, 10, 00, 19 ), Active = true, MinimumIntervalMinutes = 0 } ); } catch { }
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 8, Name = "dan.me.uk torlist", SiteUrl = "https://www.dan.me.uk", FileUrls = "https://www.dan.me.uk/torlist/index.html", FileTypeID = 1, LastDownloaded = new DateTime( 2024, 12, 18, 10, 00, 40 ), Active = true, MinimumIntervalMinutes = 45 } ); } catch { }
            ...
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 10, Name = "Internet Storm Center DShield", SiteUrl = "https://feeds.dshield.org", FileUrls = "https://feeds.dshield.org/block.txt", FileTypeID = 4, LastDownloaded = new DateTime( 2024, 12, 18, 10, 00, 47 ), Active = true, MinimumIntervalMinutes = 0 } ); } catch { }
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 11, Name = "Internet Storm Center Shodan", SiteUrl = "https://isc.sans.edu", FileUrls = "https://isc.sans.edu/api/threatlist/shodan/shodan.txt", FileTypeID = 3, LastDownloaded = new DateTime( 2024, 12, 18, 10, 00, 48 ), Active = true, MinimumIntervalMinutes = 0 } ); } catch { }
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 12, Name = "IBM X-Force Exchange", SiteUrl = "https://exchange.xforce.ibmcloud.com/", FileUrls = "https://iplists.firehol.org/files/xforce_bccs.ipset", FileTypeID = 1, LastDownloaded = new DateTime( 2024, 12, 18, 10, 00, 46 ), Active = true, MinimumIntervalMinutes = 0 } ); } catch { }
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 13, Name = "pgl.yoyo.org AdServers", SiteUrl = "https://pgl.yoyo.org", FileUrls = "https://pgl.yoyo.org/adservers/iplist.php?ipformat=&showintro=0&mimetype=plaintext", FileTypeID = 1, LastDownloaded = new DateTime( 2024, 12, 18, 10, 01, 00 ), Active = true, MinimumIntervalMinutes = 0 } ); } catch { }
            ...
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 16, Name = "Blocklist.de", SiteUrl = "http://lists.blocklist.de/lists/", FileUrls = "http://lists.blocklist.de/lists/all.txt", FileTypeID = 1, LastDownloaded = new DateTime( 2024, 12, 18, 10, 00, 15 ), Active = true, MinimumIntervalMinutes = 0 } ); } catch { }
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 17, Name = "CyberCrime-Tracker", SiteUrl = "https://cybercrime-tracker.net/fuckerz.php", FileUrls = "https://cybercrime-tracker.net/rss.xml", FileTypeID = 3, LastDownloaded = new DateTime( 2024, 12, 18, 10, 00, 20 ), Active = true, MinimumIntervalMinutes = 0 } ); } catch { }
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 18, Name = "DigitalSide Threat-Intel Repository", SiteUrl = "https://osint.digitalside.it/", FileUrls = "https://osint.digitalside.it/Threat-Intel/lists/latestips.txt", FileTypeID = 1, LastDownloaded = new DateTime( 2024, 12, 18, 10, 00, 42 ), Active = true, MinimumIntervalMinutes = 0 } ); } catch { }
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 19, Name = "abuse.ch", SiteUrl = "https://sslbl.abuse.ch/blacklist/", FileUrls = "https://sslbl.abuse.ch/blacklist/sslipblacklist.txt", FileTypeID = 1, LastDownloaded = new DateTime( 2024, 12, 18, 10, 00, 13 ), Active = true, MinimumIntervalMinutes = 0 } ); } catch { }
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 22, Name = "Miroslav Stampar", SiteUrl = "https://github.com/stamparm", FileUrls = "https://raw.githubusercontent.com/stamparm/ipsum/master/ipsum.txt", FileTypeID = 1, LastDownloaded = new DateTime( 2024, 12, 18, 10, 00, 55 ), Active = true, MinimumIntervalMinutes = 0 } ); } catch { }
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 24, Name = "James Brine", SiteUrl = "https://jamesbrine.com.au", FileUrls = "https://jamesbrine.com.au/csv", FileTypeID = 9, LastDownloaded = new DateTime( 2024, 12, 18, 10, 00, 55 ), Active = true, MinimumIntervalMinutes = 0 } ); } catch { }
            ...
            try { this.RemoteSites.Add( new RemoteSite( ) { ID = 26, Name = "Rutgers Blacklisted IPs", SiteUrl = "https://report.cs.rutgers.edu/mrtg/drop/dropstat.cgi?start=-86400", FileUrls = "https://report.cs.rutgers.edu/DROP/attackers", FileTypeID = 1, LastDownloaded = new DateTime( 2024, 12, 18, 10, 01, 01 ), Active = true, MinimumIntervalMinutes = 0 } ); } catch { }
            ...
            try
            {
                ...
                result = this.RemoteSites.Count( ) == 23;
            }
            catch ( DbUpdateException ex1 )
            {
